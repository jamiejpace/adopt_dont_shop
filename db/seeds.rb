...
application_2 = Application.create(name: 'Megan', street: '456 Walnut Dr', state: "Colorado", city: "Denver", zip_code: "90210", description: "Will give dog lots of snacks", status: "Pending")
application_3 = Application.create(name: 'Steve', street: '879 Juniper Ln', state: "Colorado", city: "Denver", zip_code: "77834", description: "Doesn't actually like dogs", status: "Rejected")
